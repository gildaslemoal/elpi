...
rcsPartyIdentification = delegator.findOne("PartyIdentification", [partyId : partyId, partyIdentificationTypeId : "RCS"], false);
if (UtilValidate.isNotEmpty(rcsPartyIdentification)) {
    context.rcsValue = rcsPartyIdentification.idValue;
}
tvaPartyIdentification = delegator.findOne("PartyIdentification", [partyId : partyId, partyIdentificationTypeId : "TVA"], false);
if (UtilValidate.isNotEmpty(tvaPartyIdentification)) {
    context.tvaValue = tvaPartyIdentification.idValue;
}
// SIRET number
siretPartyIdentification = delegator.findOne("PartyIdentification", [partyId : partyId, partyIdentificationTypeId : "SIRET"], false);
if (UtilValidate.isNotEmpty(siretPartyIdentification)) {
    context.siretValue = siretPartyIdentification.idValue;
}
