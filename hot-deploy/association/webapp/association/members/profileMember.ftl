                        ...
                        <div id="contact-information-form" class="col-md-6" style="display:none">
                            ...
                            <h3>Informations du contact
                                ...
                                <dl class="dl-horizontal">
                                    ...
                                    <dt>Date de naissance : </dt>
                                    <dd>
                                        <input type="date" class="form-control" id="userBirthdate" name="USER_BIRTHDATE" value="${person.birthDate?string["dd/mm/yyyy"]}" placeholder="${uiLabelMap.FormFieldTitle_birthDate} AAAA-MM-JJ (1953-03-16)">
                                    </dd>
                                </dl>
                            </form>
                        </div>
