...
<#if showMore>
<div class="screenlet-title-bar panel panel-primary">
    <div class="panel-heading">
    <#if title?has_content><h3 class="panel-title">${title}</h3></#if>
        <ul class="pull-right panel-toolbar">
<#if collapsible>
            <li class="<#rt/>
<#if collapsed>
collapsed"><a class="btn btn-default btn-arrow" <#if javaScriptEnabled>onclick="javascript:toggleScreenlet(this, '${collapsibleAreaId}', '${saveCollapsed?string}', '${expandToolTip}', '${collapseToolTip}');"<#else>href="${fullUrlString}"</#if><#if expandToolTip?has_content> title="${expandToolTip}"</#if>><i class="fa fa-arrow-down"
<#else>
expanded"><a class="btn btn-default btn-arrow" <#if javaScriptEnabled>onclick="javascript:toggleScreenlet(this, '${collapsibleAreaId}', '${saveCollapsed?string}', '${expandToolTip}', '${collapseToolTip}');"<#else>href="${fullUrlString}"</#if><#if collapseToolTip?has_content> title="${collapseToolTip}"</#if>><i class="fa fa-arrow-up"
</#if>
></i>&nbsp;</a></li>
</#if>
<#--
...
<div class="panel-body" <#if collapsibleAreaId?has_content> <#if collapsed> style="display: none;"</#if></#if>>
...
<#macro renderScreenletSubWidget>
</#macro>
