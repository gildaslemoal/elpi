      ...
      <div class="screenlet-body">
        <table class="basic-table" cellspacing='0'>
          ...
          <tr>
            ...
            -->
            <td>${selectedServiceMap.export}<#if selectedServiceMap.exportBool = "true">&nbsp;<span>(<a href='<@ofbizUrl>${url}?sel_service_name=${selectedServiceMap.serviceName}&amp;show_wsdl=true</@ofbizUrl>'>${uiLabelMap.WebtoolsShowShowWSDL}</a>)</span>&nbsp;&nbsp;<span>(<a href='<@ofbizUrl>${url}?sel_service_name=${selectedServiceMap.serviceName}&amp;show_wsdl=true&amp;show_wsdl_new=true</@ofbizUrl>'>${uiLabelMap.WebtoolsShowShowWSDL} ${uiLabelMap.CommonNew}</a>)</span></#if></td>
            <#--#Eam# new-wsdl-style-->
