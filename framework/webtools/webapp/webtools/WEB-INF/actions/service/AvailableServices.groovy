...
if (selectedService) {
    ...
    showWsdlNew = parameters.show_wsdl_new; /*#Eam# new-wsdl-style*/
    ...
    if (showWsdl?.equals("true")) {
        try {
            ...
            /*#Bam# new-wsdl-style*/
            if (showWsdlNew?.equals("true")) {
                wsdl = curServiceModel.generateWSDL(delegator, "http://${request.getServerName()}:${UtilProperties.getPropertyValue("url.properties", "port.http", "80")}${parameters._CONTROL_PATH_}/SOAPServiceNew");
