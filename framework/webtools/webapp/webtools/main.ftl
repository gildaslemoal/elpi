...
<#if !userLogin?has_content>
    <div class="alert alert-warning">
        <strong>${uiLabelMap.CommonWarning}</strong> ${uiLabelMap.WebtoolsForSomethingInteresting}.
        <p style="padding:10px;"></p>
        <a class="btn btn-default" href="<@ofbizUrl>checkLogin</@ofbizUrl>"><i class="fa fa-arrow-left"></i> ${uiLabelMap.CommonBack}</a>
        <a class="btn btn-default" href="<@ofbizUrl>checkLogin</@ofbizUrl>"><i class="fa fa-sign-in"></i> ${uiLabelMap.CommonLogin}</a>
    </div>
<#else>
    <div class="screenlet">
